...
/**
 * This is the global player that will be used to play the audio with streaming
 * Not used yet as we are still working on the streaming part
 * Need to encode and buffer the audio correctly to get streaming to work.
 */
