  ...
  return (
    <>
      <div className="relative">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:gap-8 lg:px-8">
          {products.map((product) => (
            ...
            >
              <div className="rounded-xl bg-primary  p-6">
                <h3 className="text-center text-4xl font-semibold leading-5 text-white">
                  {product.name}
                </h3>
