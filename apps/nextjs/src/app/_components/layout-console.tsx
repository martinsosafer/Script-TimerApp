...
const Sidebar = async ({ children }: SidebarProps) => {
  ...
  return (
    <main className="mb-8 mt-4 flex h-full overflow-y-scroll sm:mb-2 lg:overflow-hidden">
      <div className="ml-4 hidden h-5/6 w-1/2 flex-col justify-between rounded-md bg-white p-4 md:flex">
        {session && (
          <Suspense
