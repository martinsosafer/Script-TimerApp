...
export default function FAQs() {
  ...
  return (
    <div className="mb-10 flex w-full flex-col items-center justify-center bg-gray-100 p-10">
      <h2 className="mb-8 text-[34px] font-bold text-primary">FAQs</h2>
      <div
        className={`${roboto.className} flex w-full flex-col gap-2 text-xl text-black xl:w-[800px]`}
      >
        {faqs.map((faq, index) => {
          ...
          return (
            ...
            >
              <div className="mt-1 flex items-start gap-[4px] text-left text-[18px] font-bold">
              ...
              {isSelected && (
                <div className="ml-6 p-2 text-left text-[16px] text-black">
                  {faq.a}
                </div>
              )}
            </button>
