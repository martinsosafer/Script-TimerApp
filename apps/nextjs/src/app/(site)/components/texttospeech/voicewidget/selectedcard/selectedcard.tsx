  ...
  return (
    <div className="mb-2 cursor-pointer rounded-lg bg-white shadow-sm dark:bg-slate-500">
      <div className="flex items-center p-1">
        <div className="mr-2 h-5 w-5 lg:h-7 lg:w-7 flex-shrink-0 overflow-hidden rounded-full">
          {selectedModel ? (
        ...
        <div className="flex-grow">
          <h2 className="text-xs lg:text-sm font-semibold dark:text-secondary-foreground">
            {selectedModel ? selectedModel.name : "Choose Actor"}
          </h2>

          {selectedModel && (
            <p className="text-[10px] lg:text-xs text-gray-500 dark:text-slate-100">
