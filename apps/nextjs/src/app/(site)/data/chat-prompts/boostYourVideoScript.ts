...
export const BOOST_YOUR_VIDEO_SCRIPT_PROMPTS: Prompt[] = [
  {
  ...
  {
    id: "c64b067d-aa58-47f4-ab75-ccc1a05e67b8",
    ...
    prompt_display: `I will deliver a 1-2 minute script using the EPIC Story Formula by Maury Rogow. Please share your current market, product name, problems solved, and proven results, and let's make it shine`,
    icon: "/icons/ear.svg",
  },
];
