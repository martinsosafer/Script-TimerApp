...
import type { SubscriptionStatus } from "~/constants/types/subscriptions";
import type { BoosterType } from "../../boosters/types";
...
interface CreditRowProps {
  ...
  setIsBoostersModalOpen: (isOpen: boolean) => void;
}
