...
export default function PlansCards({
  ...
  return (
    <section
      ...
      id="plan-cards"
    >
      <RegularCard type="EDUCATION" period={period} session={session} />
      <RegularCard type="CREATOR" period={period} session={session} />
      <RegularCard type="BUSINESS" period={period} session={session} />
    </section>
  );
}
